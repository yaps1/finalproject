...
<script type="text/javascript">
	$(function(){
		...
		$("#check_btn").click(function(){
			let member_addr = $("#member_addr").val();	//입력창 주소를 불러옴
			if(member_addr != ""){
				$(".modal").fadeIn();	//모달창 오픈!
				
				//alert(member_addr);	//됐다!
          ...
          <div class="row g-3">
            ...
            <!--지역인증 -->
			  <div class="col-12 mb-1">
                ...
                <div style="display: inline-block; float: right; padding-right: 158px;">
              	 	<button type="button" id="check_btn" class="w-100 btn btn-secondary btn-sm" style="height:45px; padding:0 120px; float: left; font-size: 15px;">확인</button> 
                </div>
	        	<!-- 지역인증 결과 div -->
