 ...
 <div class="p-1 bg-secondary bg-gradient text-end text-white d-flex justify-content-end">
         ...
         <c:if test="${empty m}">
          <ul>
         	...
         	<li class="text-end text-white" id="top-header"><a href="/search.jsp">통합검색</a><li>
         </ul>
         </c:if>
        ...
        <!-- 드롭 다운 메뉴 -->
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdown08" style="width: 176px;">
              <li style="padding-left: 11px; padding-right: 4px;"><a class="dropdown-item fw-bold text-secondary fs-2 pt-2 pb-2 border-bottom" href="#">&nbsp;소모임&nbsp;</a></li>
              <li style="padding-left: 7px;"><a class="dropdown-item fw-bold text-secondary fs-2 pt-2 pb-2" href="#">맛집공유</a></li>
            </ul>
          </li>
